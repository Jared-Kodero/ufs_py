...
class DiagTable:
    def __init__(self, diag_table_file="Diag_Table"):
        ...
        if not path.exists(self.diag_table_file):
            exit("file " + self.diag_table_file + " does not exist")
        ...
        if "none" in myval:
            ...
            if (
                ...
                print(
                    "The "
                    + file_name
                    + " has multiple sub_regions defined. Be sure that all the variables \
    ...
    def parse_diag_table(self):
        ...
        while global_count < 2:
            ...
            iline_count += 1
            if (
                iline.strip() != "" and "#" not in iline.strip()[0]
                ...
                if global_count == 0:
                    try:
                        ...
                        exit(
                            " ERROR2 with line # " + str(iline_count) + "\n"
                            " CHECK:            " + str(iline) + "\n"
                        )
            ...
            if (
                ...
                try:
                    ...
                    for i in range(len(iline_list)):
                        j = i
                        if i == 3:
                            continue  # do not do anything with the "file_format" column
                        if i > 3:
                            j = i - 1
                        ...
                        if i == 9 and myval <= 0:
                            continue  # ignore file_duration if it less than 0
                        if i == 10 and myval == "":
                    ...
                    try:
                        ...
                        for i in range(len(self.field_section_keys)):
                            ...
                            buf = iline_list[i]
                            if i == 4:
                                continue  # do not do anything with the "time_sampling" section
                            if i > 4:
                                j = i - 1
                            if (
                                i == 5
                            ...
                            if i == 7:  # Set the kind to either "float" or "double"
                                if "2" in buf:
                                    ...
                                    exit("Error: the kind needs to be 1 or 2")
                        ...
                        exit(
                            " ERROR3 with line # " + str(iline_count) + "\n"
                            " CHECK:            " + str(iline) + "\n"
                        )
